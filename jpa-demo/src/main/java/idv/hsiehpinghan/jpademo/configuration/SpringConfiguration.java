...
public class SpringConfiguration {
	...
	private Properties getHibernateProperties() {
		...
		prop.put("hibernate.cache.use_second_level_cache",
				environment.getRequiredProperty("hibernate.cache.use_second_level_cache"));
		prop.put("hibernate.cache.use_query_cache", environment.getRequiredProperty("hibernate.cache.use_query_cache"));
		prop.put("net.sf.ehcache.configurationResourceName",
